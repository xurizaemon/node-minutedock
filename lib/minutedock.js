    ...
    this.api = {
        ...
        entries:{
            ...
            update:function (id, data, callback) {
                ...
                return self.request('entries/' + id + '.json', "PUT", form_data, function (err, entry) {
                    callback(err, entry);
                });
            },
        ...
        projects:{
            all:function (accountID, callback) {
                var data = { account_id:accountID };
                return self.request('projects.json', "GET", data, function (err, projects) {
            ...
            new:function (accountID, data, callback) {
                ...
                return self.request('projects.json', "POST", form_data, function (err, projects) {
                    callback(err, projects);
                });
            },
            update:function (id, data, callback) {
                var form_data = { project:data };
                return self.request('projects/' + id + '.json', "PUT", form_data, function (err, projects) {
                    callback(err, projects);
                });
            },
            delete:function (id, callback) {
                return self.request('projects/' + id + '.json', "DELETE", function (err, projects) {
                    callback(err, projects);
                });
            },
            archive:function (id, callback) {
                return self.request('projects/' + id + '/archive.json', "POST", function (err, projects) {
                    callback(err, projects);
                });
            }
        }
